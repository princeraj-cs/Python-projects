...
try:
    ...
    pass  # Continue without image if file not found
timer_text = canvas.create_text(100, 130, text="00:00", fill="white", font=(FONT_NAME, 35, "bold"))
canvas.grid(column=1, row=1)

timer_label = Label(text="Timer", fg=GREEN, font=(FONT_NAME, 40, "bold"), background=YELLOW)
...
tick_mark = Label(fg=GREEN, font=(FONT_NAME, 35, "bold"), background=YELLOW)
